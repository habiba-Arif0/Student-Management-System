...
public class Table extends JPanel {
    ...
    private int width;
    private int height;
    private String[] columns = {"ID", "Firstname", "Lastname", "Age"};
    ...
    public void addRow(String id, String firstname, String lastname, String age) {
        // Adds a single row of student data to the table

        Object[] data = {id, firstname, lastname, age};
        this.tableModel.addRow(data);
    }

    public void insertRow(int index, String id, String firstname, String lastname, String age) {
        Object[] data = {id, firstname, lastname, age};
